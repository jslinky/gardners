...
<section class="container-alt mx-auto 2xl:max-w-screen-xl">
    <div class="mt-14 flex flex-col md:flex-row md:items-center lg:px-8">
    <div class="md:w-1/2">          
        ...
        <button class="bg-white primary font-semibold py-3 rounded hover:text-primary-shade mt-6">
            Find out more
            <MoveRight class="inline-block ml-2" />
        </button>
        </div>
    </div>
    <div class="md:w-1/2 mt-6 md:mt-0 md:pl-8 aspect-video overflow-clip">
        <img 
        src="../../assets/img/about-us-banner.jpg" 
        alt="Warehouse or Bookshelves" 
        class="rounded shadow object-cover h-full"
        />
    </div>
    </div>    
</section>
